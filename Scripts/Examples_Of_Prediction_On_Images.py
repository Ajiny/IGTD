...
from Prediction_Modeling_Functions import get_model_parameter, load_example_data, get_data_for_cross_validation, CNN2D_Classification_Analysis



# Load the example drug response data, cell line gene expression image data, and drug descriptor image data
res, ccl = load_example_data()
...
train, val, test = get_data_for_cross_validation(res, ccl, sampleID)
